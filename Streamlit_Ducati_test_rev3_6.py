...
#df_take_rate_donut.groupby(['Versione']).mean()
...
#fig3 = px.treemap(df_take_rate, path=['Versione','Optional'],
#                  values='%_Optional',
#                  color='%_Versione',
#                  color_continuous_scale="reds",
#                  title = 'Take rate',
#                  width=850, height=750)
#fig3.update_layout(paper_bgcolor="rgb(0,0,0,0)",
#                 font_color="white")
...
#df_sequenza.to_excel('/Users/marcello_galimberti/Documents/Marcello Galimberti/ADI business consulting/Offerte 2023/Ducati 2023/ASC/Simulazione/df_sequenza_cluster_rev3.xlsx')
...
st.bar_chart(data=df_grafico_sequenza, x='Sequenza', y='TCT',use_container_width=True)
